<div
    class="container min-h-screen relative grid grid-cols-1 sm:grid-cols-2  gap-6 mt-8 pb-6 lg:mt-16  lg:gap-4 lg:grid-cols-4 m-auto ">
    <div class="card group relative overflow-hidden w-72 h-80 m-auto sm:m-6">
        ...
        group-hover:flex group-hover:justify-center group-hover:items-center">
            ...
            group-hover:translate-x-0 group-hover:delay-75">
                ...
                <p class=" text-sm font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem, nisi
                    eligendi perferendis
                    voluptatem dicta facilis tenetur magnam atque id doloribus alias optio odio quis earum modi saepe.
